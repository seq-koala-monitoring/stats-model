...
# Model: saturated model with independent spatial random-effect spatial variation in trends and with order = 1 and lag = 1 with 3 chains
...
saveRDS(Samples, "output/mcmc/sat_spind_var_trend_order1_lag1.rds")
