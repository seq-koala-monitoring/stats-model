...
# Model: saturated model with independent spatial random-effect no spatial variation in trends and with order = 1 and lag = 1 with 3 chains
...
saveRDS(Samples, "output/mcmc/sat_spind_const_trend_order1_lag1.rds")
