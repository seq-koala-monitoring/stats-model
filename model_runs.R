library(MCMCvis)
MCMCsummary(Samples_Combined$MCMC)
MCMCplot(Samples_Combined$MCMC)
MCMCtrace(Samples_Combined$MCMC)
MCMCtrace(list(Samples[[1]]$samples,Samples[[2]]$samples,Samples[[3]]$samples))
